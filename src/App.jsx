...
//         params: {
//           key: "9a54a0b6585443e1bfb182245240410", // Replace with your WeatherAPI key
//           q: cityName,
//         },
//       });
...
//   return (
//       <div className="flex justify-center align-center flex-col bg-blue-200">    
     
//       <h1 className="text-4xl text-center font-bold mb-8 text-blue-700">Weather Dashboard</h1>
...
//           className="p-3 rounded-l-md rounded-border outline-none"
//         />
//         <button
//           type="submit"
...
const App = () => {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""}`}>
      <div className="flex justify-center align-center flex-col bg-blue-200 transition-all min-h-screen">
        ...
        <h1 className="text-4xl text-center font-bold mb-8 text-blue-700">
          Weather Dashboard
        </h1>
       ...
       {/* Search bar */}
        <form onSubmit={handleSearch} className="flex space-x-2 mb-6 justify-center">
          <input
            ...
            value={city}
            onChange={(e) => setCity(e.target.value)}
            className="p-3 rounded-l-md rounded-border outline-none bg-white text-gray-400"
          />
          <button
            type="submit"
            className="p-3 bg-blue-500 text-white rounded-r-md hover:bg-blue-700"
